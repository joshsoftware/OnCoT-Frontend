      ...
      <Row>
        <Col>
          { showOutput
            ? (
              <Card
                className='rounded-0 card bg-dark text-white font-weight-bold'
              >
                <CardHeader className='py-3 px-3 text-left'>
                  OUTPUT
                  {' '}
                  {loading
                    ? <Spinner size='sm' />
            ...
            :						(
              <Card
                className='card bg-dark text-white rounded-0 font-weight-bold'
              >
