...
export const getTestCasesApi = (data) => {
  return get(`https://oncot-platform.herokuapp.com/api/v1/admin/problem/${data.problem_id}/test_cases`);
};

export const updateTestCaseApi = (data) => {
  return put(`https://oncot-platform.herokuapp.com/api/v1/admin/test_cases/${data.id}`, data);
};
